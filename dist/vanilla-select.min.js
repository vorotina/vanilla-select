...
$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(a,c,e){a!=Array.prototype&&a!=Object.prototype&&(a[c]=e.value)};$jscomp.getGlobal=function(a){return"undefined"!=typeof window&&window===a?a:"undefined"!=typeof global&&null!=global?global:a};$jscomp.global=$jscomp.getGlobal(this);
...
function(){};a.prototype.setState=function(a,b){var d=this.state,c="function"==typeof a?a(d,this.props):a;this.state=Object.assign(d,c);this.shouldComponentUpdate(d,c)&&this.forceUpdate();b&&b.call(this);return this};a.prototype.forceUpdate=function(){this.componentUpdate(this.props,this.state);return this};a.prototype.shouldComponentUpdate=function(a,b){return a!==b};a.prototype.componentUpdate=function(a,b){this.$el&&(this.componentWillUpdate(a,b),this.$dispose("updated"),this.$el.innerHTML=this.render(a,
...
b.dropdown=new e(Object.assign({},b.props,{onSelected:function(a){b.props.onSelected&&b.props.onSelected(a);b.setState(function(b){return{placeholder:a.text||a.value,selected:a,expanded:!1}})}}));return b};$jscomp.inherits(c,a);c.prototype.onDocumentClick=function(a){var b=this;a.path.some(function(a){return a===b.$el})||this.setState(function(a){return{expanded:!1}})};c.prototype.onToolboxClick=function(a){var b=this;this.setState(function(a){return{expanded:!a.expanded}},function(){b.props.search&&
b.state.expanded&&b.dropdown.refs.query.focus()})};c.prototype.render=function(a,b){return'<div class="select__box">\n                    <div ref="toolbox" class="select__toolbox">\n                        <i class="select__arrow" aria-hidden="true"></i>\n                        <div class="select__label">'+b.placeholder+'</div>\n                    </div>\n                    <div ref="dropdown" class="select__dropdown '+(b.expanded?"select__dropdown--show":"")+'"></div>\n                </div>'};
c.prototype.componentDidMount=function(){var a=this;document.body.addEventListener("click",this.onDocumentClick);this.$defer("mounted",function(){return document.body.removeEventListener("click",a.onDocumentClick)})};c.prototype.componentDidUnmount=function(){this.dropdown.componentUnmount()};c.prototype.componentDidUpdate=function(){var a=this,b=this.refs.toolbox;b.addEventListener("click",this.onToolboxClick);this.$defer("updated",function(){return b.removeEventListener("click",a.onToolboxClick)});
this.dropdown.componentMount({el:this.refs.dropdown})};var e=function(d){d=a.call(this,d)||this;d.state={query:"",dataset:d.props.dataset||[],selected:d.props.selected};d.onQueryChanged=d.onQueryChanged.bind(d);d.onItemClicked=d.onItemClicked.bind(d);return d};$jscomp.inherits(e,a);e.prototype.onQueryChanged=function(a){var b=a.target.value,d=new RegExp(b,"gi"),c=(this.props.dataset||[]).filter(function(a){return d.test(a.text||a.value||"")});this.setState(function(a){return{query:b,dataset:c}})};
e.prototype.onItemClicked=function(a){a=a.target.closest("li").dataset.index;var b=this.state.dataset[a];this.props.onSelected&&this.props.onSelected(b);this.setState(function(a){return{selected:b}})};e.prototype.render=function(a,b){if(0===b.dataset.length)return'<input ref="query" type="text" value="'+b.query+'" class="select__query">\n                    <span class="select__query_noresult">'+(a.noResults||"")+"</span>";var c="";a.search&&(c='<input ref="query" type="text" value="'+b.query+'" class="select__query">');
...
(a.text||a.value)+"</span>\n                                    </li>"}).join("")+"\n                    </ul>"};e.prototype.componentDidUpdate=function(){var a=this;if(this.props.search){var b=this.refs.query;b.addEventListener("change",this.onQueryChanged);this.$defer("updated",function(){return b.removeEventListener("change",a.onQueryChanged)})}var c=this.refs.list;c&&(c.addEventListener("click",this.onItemClicked),this.$defer("updated",function(){return c.removeEventListener("click",a.onItemClicked)}))};
return c});
