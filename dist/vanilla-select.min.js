...
(a.icon||"")+'" aria-hidden="true"></i>\n                                        <span class="select__item_text">'+(a.text||a.value)+"</span>\n                                    </li>"}).join("")+"\n                    </ul>"};e.prototype.componentDidUpdate=function(){var a=this,c=this.$el,d=c.getBoundingClientRect();d.top+d.height>window.innerHeight&&(c.style.marginTop=-c.clientHeight-c.parentElement.clientHeight+"px");if(this.props.search){var e=this.refs.query;e.addEventListener("change",this.onQueryChanged);
this.$defer("updated",function(){return e.removeEventListener("change",a.onQueryChanged)})}var f=this.refs.list;f&&(f.addEventListener("click",this.onItemClicked),this.$defer("updated",function(){return f.removeEventListener("click",a.onItemClicked)}))};return d});
