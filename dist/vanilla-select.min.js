...
(a.text||a.value)+"</span>\n                                    </li>"}).join("")+"\n                    </ul>"};e.prototype.componentDidMount=function(){var a=this.$el.getBoundingClientRect(),c=a.top+a.height<window.innerHeight;this.state.openDownwards!==c&&this.setState(function(a){return{openDownwards:c}})};e.prototype.componentDidUpdate=function(){var a=this;this.state.openDownwards||(this.$el.style.marginTop=-this.$el.clientHeight-this.$el.parentElement.clientHeight);if(this.props.search){var c=
this.refs.query;c.addEventListener("change",this.onQueryChanged);this.$defer("updated",function(){return c.removeEventListener("change",a.onQueryChanged)})}var d=this.refs.list;d&&(d.addEventListener("click",this.onItemClicked),this.$defer("updated",function(){return d.removeEventListener("click",a.onItemClicked)}))};return d});
