...
var e=function(b){b=a.call(this,b)||this;b.state={query:"",dataset:b.props.dataset||[],selected:b.props.selected,openDownwards:!0};b.onQueryChanged=b.onQueryChanged.bind(b);b.onItemClicked=b.onItemClicked.bind(b);return b};$jscomp.inherits(e,a);e.prototype.onQueryChanged=function(a){var b=a.target.value,d=new RegExp(b,"gi"),e=(this.props.dataset||[]).filter(function(a){return d.test(a.text||a.value||"")});this.setState(function(a){return{query:b,dataset:e}})};e.prototype.onItemClicked=function(a){if((a=
a.target.closest("li"))&&this.state){var b=this.state.dataset[a.dataset.index];this.props.onSelected&&this.props.onSelected(b);this.setState(function(a){return{selected:b}})}};e.prototype.render=function(a,c){if(0===c.dataset.length)return'<input ref="query" type="text" value="'+c.query+'" class="select__query">\n                    <span class="select__query_noresult">'+(a.noResults||"")+"</span>";var b="";a.search&&(b='<input ref="query" type="text" value="'+c.query+'" class="select__query">');
...
(a.text||a.value)+"</span>\n                                    </li>"}).join("")+"\n                    </ul>"};e.prototype.componentDidUpdate=function(){var a=this,c=this.$el,d=c.getBoundingClientRect();d.top+d.height>window.innerHeight&&(c.style.marginTop=-c.clientHeight-c.parentElement.clientHeight+"px");if(this.props.search){var e=this.refs.query;e.addEventListener("change",this.onQueryChanged);this.$defer("updated",function(){return e.removeEventListener("change",a.onQueryChanged)})}var f=this.refs.list;
f&&(f.addEventListener("click",this.onItemClicked),this.$defer("updated",function(){return f.removeEventListener("click",a.onItemClicked)}))};return d});
