...
b),this.refs=Array.from(this.$el.querySelectorAll("[ref]")).reduce(function(a,b){return a[b.getAttribute("ref")]=b,a},{}),this.componentDidUpdate(a,b))};a.prototype.componentWillUpdate=function(a,b){};a.prototype.render=function(a,b){return""};a.prototype.componentDidUpdate=function(a,b){};var c=function(d){var b=a.call(this,d)||this;d=b.props.selected;b.state={placeholder:d&&d.text?d.text:d||b.props.placeholder||"",selected:d||null,expanded:!1};b.onDocumentClick=b.onDocumentClick.bind(b);b.onToolboxClick=
b.onToolboxClick.bind(b);b.dropdown=new e(Object.assign({},b.props,{onSelected:function(a){b.props.onSelected&&b.props.onSelected(a);b.setState(function(b){return{placeholder:a.text||a.value,selected:a,expanded:!1}})}}));return b};$jscomp.inherits(c,a);c.prototype.onDocumentClick=function(a){a.$owner!==this&&this.setState(function(a){return{expanded:!1}})};c.prototype.onToolboxClick=function(a){var b=this;a.$owner=this;this.setState(function(a){return{expanded:!a.expanded}},function(){b.props.search&&
b.state.expanded&&b.dropdown.refs.query.focus()})};c.prototype.render=function(a,b){return'<div class="select__box '+(b.expanded?"select__box--expanded":"")+'">\n                    <div ref="toolbox" class="select__toolbox">\n                        <i class="select__arrow" aria-hidden="true"></i>\n                        <div class="select__label">'+b.placeholder+'</div>\n                    </div>\n                    <div ref="dropdown" class="select__dropdown '+(b.expanded?"select__dropdown--show":
...
a.onToolboxClick)});this.dropdown.componentMount({el:this.refs.dropdown})};var e=function(d){d=a.call(this,d)||this;d.state={query:"",dataset:d.props.dataset||[],selected:d.props.selected,openDownwards:!0};d.onQueryChanged=d.onQueryChanged.bind(d);d.onItemClicked=d.onItemClicked.bind(d);return d};$jscomp.inherits(e,a);e.prototype.onQueryChanged=function(a){var b=a.target.value,c=new RegExp(b,"gi"),d=(this.props.dataset||[]).filter(function(a){return c.test(a.text||a.value||"")});this.setState(function(a){return{query:b,
dataset:d}})};e.prototype.onItemClicked=function(a){if((a=a.target.closest("li"))&&this.state){var b=this.state.dataset[a.dataset.index];this.props.onSelected&&this.props.onSelected(b);this.setState(function(a){return{selected:b}})}};e.prototype.render=function(a,b){if(0===b.dataset.length)return'<input ref="query" type="text" value="'+b.query+'" class="select__query">\n                    <span class="select__query_noresult">'+(a.noResults||"")+"</span>";var c="";a.search&&(c='<input ref="query" type="text" value="'+
b.query+'" class="select__query">');return c+'\n                    <ul ref="list" class="select__list">\n                        '+b.dataset.map(function(a,c){var d=a.content||a.text||a.value;return'\n                                <li class="select__item '+(a===b.selected||a.value===b.selected?"select__item--selected":"")+" "+(a.class||"")+'" data-index="'+c+'" data-value="'+d+'">\n                                    <i class="select__item_icon '+(a.icon||"")+'" aria-hidden="true"></i>\n                                    <span class="select__item_text">'+
d+"</span>\n                                </li>"}).join("")+"\n                    </ul>"};e.prototype.componentDidUpdate=function(){var a=this,b=this.$el,c=b.getBoundingClientRect();c.top+c.height>window.innerHeight&&(b.style.marginTop=-b.clientHeight-b.parentElement.clientHeight+"px");if(this.props.search){var e=this.refs.query;e.addEventListener("change",this.onQueryChanged);this.$defer("updated",function(){return e.removeEventListener("change",a.onQueryChanged)})}var f=this.refs.list;f&&(f.addEventListener("click",
this.onItemClicked),this.$defer("updated",function(){return f.removeEventListener("click",a.onItemClicked)}))};return c});
